...
! function(a, b) {
    ...
    ! function(a) {
        ...
        x.VERSION = "1.13.1", x.DEFAULTS = {
            noneSelectedText: "Seleccione 1 o 2 nacionalidades",
            noneResultsText: "No results matched {0}",
            countSelectedText: function(a, b) {
                return 1 == a ? "{0} opción seleccionada" : "{0} opciones seleccionadas"
            },
            maxOptionsText: function(a, b) {
                return [1 == a ? "Limite alcanzado ({n} nacionalidades m&aacute;ximo)" : "Limite alcanzado ({n} nacionalidades m&aacute;ximo)", 1 == b ? "Group limit reached ({n} item max)" : "Group limit reached ({n} items max)"]
            },
